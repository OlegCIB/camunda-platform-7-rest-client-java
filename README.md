...
```
# New CIB seven properties (preferred)
cibseven.bpm.client.base-url: http://localhost:8080/engine-rest

# Legacy Camunda properties (for backward compatibility)
...
```
# Auto-deployment configuration (maintained for backward compatibility)
